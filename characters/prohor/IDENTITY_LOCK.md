...
### Шрам переведён в композ — 21.08.2026

В принятом turnaround рубец лёг на надбровную дугу, в sh08 и sh11 ушёл выше, на лоб.
Каждый раз в правой части лица, каждый раз тонкий и горизонтальный, но высота гуляет
от генерации к генерации.

Канон уже правился под факт один раз. Править его второй раз — признать, что канона нет.

**Решение: шрам рисуется в композе, как и текст.** Модель генерирует лицо, рубец
ставится вручную в фиксированную точку по маске. Кадров с лицом в эпизоде три,
операция та же, что с цифрами на кнопках лифта, и взамен шрам перестаёт двигаться
до конца сезона.

В промпт лица шрам больше **не пишется вообще**: любое упоминание тянет модель
рисовать лишние линии на лбу. Точка постановки — `characters/prohor/SCAR_ANCHOR.md`.
